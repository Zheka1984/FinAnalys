...
public class TechAnalyz {
	 ...
	 public static BarSeries loadBitstampSeries(String aktiv) {
        ...
        InputStream stream = TechAnalyz.class.getClassLoader()
                .getResourceAsStream(aktiv+".csv");
...
//	 return zdt;
	 try {
		 ...
		 zdt = ZonedDateTime.of(LocalDate.parse(arr[0], DateTimeFormatter.ofPattern("d-L-u")), time, ZoneId.of("GMT+0"));
